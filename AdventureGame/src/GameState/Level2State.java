...
public class Level2State extends GameState {
    ...
    public void update() {
        ...
        if(player.getx() == 40 && player.gety() == 80) {gsm.setState(GameStateManager.LEVEL3STATE);}

        if(player.gety() >= 282) { gsm.setState(GameStateManager.LEVEL2STATE);}
    }
